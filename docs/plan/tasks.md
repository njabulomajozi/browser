...
**Project**: Browser MVP (Rust + wry platform WebViews)
...
- [x] Create `packages/storage/` crate
- [x] Design database schema (history, bookmarks, settings)
- [x] Implement DatabaseManager with rusqlite
- [x] Write migration system (version tracking)
- [x] Add CRUD operations for history
- [x] Add CRUD operations for bookmarks
- [x] Persist browsing history automatically
- [x] Write unit tests for all DB operations

**Testing**:

- [x] Insert 1000 history entries, verify performance
- [x] Concurrent reads/writes (multi-threaded test)
- [ ] Database recovery on corruption (deferred to Phase 2)
